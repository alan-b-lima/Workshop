...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            workshop.setManager(new Manager("Manager Name", "38999999999", "987.654.321-00", 5000.0, "password123"));
    ...
    // {
    // Expense e1 = new Expense("Café", "Café para os funcionários", 600.00,
    // 245984465);
    ...
    // try {
    // DateSpan shift = new DateSpan(WDate.parse("04/05/2025 18:55"),
    // WDate.parse("04/05/2025 23:59"));
